...
private[spark] class Client(
  ...
  def submitApplication(): ApplicationId = {
    ...
    try {
      ...
      // 向ResourceManager申请一个application
      ...
      // 为ApplicationMaster的启动准备环境
      val containerContext = createContainerLaunchContext(newAppResponse)  // amContainer
  ...
  def createApplicationSubmissionContext(
    ...
    // 可以使用参数spark.yarn.am.nodeLabelExpression指定一个特殊node来运行amContainer
