...
public class ZKWatcher implements Watcher, Abortable, Closeable {
  ...
  public ZKWatcher(Configuration conf, String identifier, Abortable abortable,
    ...
    if (clientZK) {
      ...
      /**
       * 解析zoo.cfg,得到zookeeper server的列表   xxx:2181,yyy:2181
       */
    ...
    /**
     * 获取zk连接
     * recoverableZooKeeper 内部有一个成员变量 Zookeeper zk
     * HMaster 以及 HRegionServer  都是通过recoverableZooKeeper来完成对zookeeper的操作的
     *
     */
