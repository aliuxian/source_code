  ...
  throws IOException, RuntimeException {
    ...
    for (int tries = 0;; tries++) {
      ...
      try {
        /***
         * 调用刚刚实现的匿名内部类的call方法
         * 执行成功就会直接返回，执行失败去到catch块，处理，然后继续重试，知道重试次数用完
         * DDL  callable =》 MaterCallable
         * DML  callable =》 ClientServiceCallable （RegionServerCallable）
         *
         *
         *
         * prepare：
         *        MasterCallable   =》  获取HMaster的一个代理
         *        ClientServiceCallable   =》   获取对应region的位置
         */
